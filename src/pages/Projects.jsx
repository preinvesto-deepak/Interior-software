              ...
              {rooms.length === 0 ? (
                ...
                <>
                  ...
                  <Section title={`Items in ${activeRoom.subProject}`} badge={roomItems.length} defaultOpen>
                                ...
                                <tr key={item.id}>
                                  ...
                                  <td>
                                    <div style={{ display: "flex", gap: 4, justifyContent: "center" }}>
                                      ...
                                      <button onClick={() => navigate(`/boq?record=${item.id}`)} style={{ background: "#059669", padding: "3px 9px", fontSize: 11 }}>BOQ</button>
                                      <button onClick={() => navigate(`/quotation?record=${item.id}`)} style={{ background: "#7c3aed", padding: "3px 9px", fontSize: 11 }}>Quote</button>
                                    </div>
                                  </td>
                                </tr>
                              );
                    ...
                    <button
                      onClick={() => navigate("/wardrobe-configurator")}
                  ...
                  <Section title="Output" defaultOpen={false}>
                    ...
                    <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                      <button onClick={() => navigate("/cut-sheet-output")} style={{ background: "#0891b2" }}>Cut Sheet</button>
                      <button onClick={() => navigate("/boq")} style={{ background: "#059669" }}>BOQ (Single Item)</button>
                      <button onClick={() => navigate(`/project-boq?project=${encodeURIComponent(selectedProject.name)}`)} style={{ background: "#047857" }}>Project BOQ</button>
                      <button onClick={() => navigate("/quotation")} style={{ background: "#7c3aed" }}>Quotation</button>
                      <button onClick={() => navigate(`/project-quotation?project=${encodeURIComponent(selectedProject.name)}`)} style={{ background: "#6d28d9" }}>Project Quotation</button>
                    </div>
                  </Section>
                </>
              ) : null}
